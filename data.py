...
class BunsIngredients:
    ...
    mock_bun2.get_price.return_value = 200.0
    ...
    # Вывод сформированного рецепта для 1 булочки и 1 ингредиента
    @staticmethod
    def get_simple_receipt(bun, ingredient):
